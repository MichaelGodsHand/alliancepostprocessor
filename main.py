...
# FastAPI app
app = FastAPI(title="Alliance Postprocessor", version="1.0.0")
...
- Common course names at Alliance College include: Computer Science and Engineering, Information Technology, Electronics and Communication Engineering, Electrical and Electronics Engineering, Mechanical Engineering, AIML, etc.
